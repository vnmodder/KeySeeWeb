        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsertUserID = table.Column<Guid>(type: "UNIQUEIDENTIFIER", nullable: true, comment: "InsertUserId"),
                    InsertDate = table.Column<DateTime>(type: "DATETIME", nullable: true, defaultValueSql: "GETUTCDATE()", comment: "InsertDate"),
                    UpdateUserID = table.Column<Guid>(type: "UNIQUEIDENTIFIER", nullable: true, comment: "UpdateUserId"),
                    UpdateDate = table.Column<DateTime>(type: "DATETIME", nullable: true, defaultValueSql: "GETUTCDATE()", comment: "UpdateDate"),
                    DeleteUserID = table.Column<Guid>(type: "UNIQUEIDENTIFIER", nullable: true, comment: "DeleteUserId"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TestName = table.Column<string>(type: "char(12)", unicode: false, fixedLength: true, maxLength: 12, nullable: true),
                    ID = table.Column<Guid>(type: "UNIQUEIDENTIFIER", nullable: true, comment: "Khóa chính"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4f50eced-d9bf-48e6-839e-8e64b5376c87"), "3", "User", "User" },
                    { new Guid("7f148f64-bd44-4883-91b0-8751a0629fe4"), "1", "Zero", "Zero" },
                    { new Guid("e12a0bcb-2fb5-4b97-8b34-276f3e4e5d55"), "2", "Admin", "Admin" }
                });
