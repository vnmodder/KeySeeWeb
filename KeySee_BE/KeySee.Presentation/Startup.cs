using KeySee.Application;
using KeySee.Presentation.Filters;
...
using Serilog;
using KeySee.Infrastructure;
using Microsoft.ApplicationInsights.AspNetCore.Extensions;
using Newtonsoft.Json;

namespace KeySee.Presentation
{
    public class Startup
    {
        ...
        public void Configure(IServiceProvider provider, IApplicationBuilder application, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            .UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "KEYSEE API v1");
            });
